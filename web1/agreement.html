...
<style type="text/css">
.fr_tit { line-height:3; text-align:center; }
.form_fr { width:960px; margin:20px auto; }
</style>	
</head>
<body>
	...
	<form action="join.jsp" class="frm" method="post" name="agree_form" onsubmit="return send(this)">
		<div class="form_fr">
		   <h2 class="fr_tit">회원 약관</h2>	
			<textarea cols="140" rows="80" readonly>
				제 1 장 총칙
				제 1 조 (목적)
		...
		<br />
		<div class="form_fr">
		   <h2 class="fr_tit">개인정보처리 방침</h2>	
			<textarea cols="140" rows="40" readonly>
			2. 개인정보 수집
